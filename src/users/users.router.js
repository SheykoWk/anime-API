...
const { uploadCoverUser } = require('../utils/multer')
...
router.route('/me/profile-img')
    .post(passport.authenticate('jwt', {session: false}), uploadCoverUser().single('chapter-video'), userServices.postProfileImg)
    //.get()
