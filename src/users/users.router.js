...
const { updateProfileImage } = require('../utils/multer')
...
router.route('/me/profile-img')
    .post(passport.authenticate('jwt', {session: false}), updateProfileImage().single('profile-img'), userServices.postProfileImg)
    //.get()
